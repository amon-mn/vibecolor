...
export const EmotionSelector: React.FC<EmotionSelectorProps> = ({ value, onChange }) => (
  <div className="flex flex-col gap-2 w-full max-w-xs mx-auto">
    <label htmlFor="emotion-select" className="font-semibold text-gray-700">Escolha uma emoção/estilo:</label>
    <select
      id="emotion-select"
    ...
    <span id="emotion-help" className="text-xs text-gray-500">Escolha a emoção ou estilo desejado para influenciar a paleta de cores.</span>
  </div>
); 